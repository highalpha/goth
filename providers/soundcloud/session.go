...
// Session stores data during the auth process with Soundcloud.
type Session struct {
	AuthURL      string
	AccessToken  string
	RefreshToken string
...
// GetAuthURL will return the URL set by calling the `BeginAuth` function on the Soundcloud provider.
